...
export RESULTS_FLUX_AGGREGATES_PARTIAL=${paths[location_of_this_file]}/../results/partials/flux-aggregates3.R
...
Rscript ${paths[location_of_this_file]}/../results/flux-aggregates3.R \
...
echo "plot_mf.R"
Rscript ${paths[location_of_this_file]}/../results/plot_mf3.R \
