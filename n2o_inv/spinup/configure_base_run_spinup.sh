#!/bin/bash
# This script creates the required files to run GEOSChem for the spinup simulation
...
# Match obs
sed -i -e "s#Turn on ObsPack diag?   : F#Turn on ObsPack diag?   : T#" \
       -e "s#Quiet logfile output    : F#Quiet logfile output    : T#" \
       -e "s#./obspack_co2_1_OCO2MIP_2018-11-28.YYYYMMDD.nc#$obspack_dir/obspack_n2o.YYYYMMDD.nc#" \
       -e "s#./OutputDir/GEOSChem.ObsPack.YYYYMMDD_hhmmz.nc4#$output_dir/$case/su_01/GEOSChem.ObsPack.YYYYMMDD_hhmmz.nc4#" \
       -e "s#ObsPack output species  : NO CO O3#ObsPack output species  : ?ADV?#" input.geos
